  ...
  <section class="container px-4 mx-auto mt-8">
        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">2</td>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                  <div>
              ...
              <tr>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">3</td>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                  <div>
              ...
              <tr>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">4</td>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                  <div>
              ...
              <tr>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">5</td>
                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                  <div>
    ...
    <div class="mt-6 sm:flex sm:items-center sm:justify-between ">
      <div class="text-sm text-gray-500 dark:text-gray-400">
        Página <span class="font-medium text-gray-700 dark:text-gray-100">1 of 10</span>
      </div>

      <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
        <a href="#" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800">
          <ArrowLeftIcon class="h-4 w-4 flex-shrink-0" />
